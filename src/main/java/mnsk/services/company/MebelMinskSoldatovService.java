...
public class MebelMinskSoldatovService extends ImporterService {

    public static final String BASE_URL = "https://www.mebelminsk.by/";
    public static final String CATEGORY_URL = "companies/soldatov";
    public static final String SELECTOR_FOR_PRODUCTS_ON_MAIN_PAGE = "div.row.catalog item figure";
    public static final String BRAND = "Собственное производство";
    ...
    public static void getProductData() {
        ...
        try {
            ...
            Elements elements = preview.select("div.row.catalog").first().select("div.item figure a");
            if (elements.size() == 0) {
