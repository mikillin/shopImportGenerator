    ...
    public static final ArrayList<Map<String, InnerClass>> PRODUCT_NAME_CLASSIFICATION_RULES = new ArrayList<Map<String, InnerClass>>() {
        {
            ...
            add(Map.of("Кровать,Кровать-диван,Основание кроватное,Без матраца,Ортопедическое основание", new InnerClass("Мебель для спальни", "Кровати")));
            ...
            add(Map.of("Зеркало", new InnerClass("Мебель для спальни", "Зеркала")));
            add(Map.of("Шкаф трехстворчатый,Шкаф двустворчатый,Шкаф пятистворчатый,Шкаф,Надстройка,Шкаф навесной,Полки для шкафа,Приставка к шкафу,Шкаф настенный с зеркалом,Панель с зеркалом", new InnerClass("Мебель для спальни", "Шкафы")));
            ...
            add(Map.of("Кровать выдвижная,Кровать двухъярусная,Набор мебели Студент-Люкс,Модульная детская,Детская", new InnerClass("Мебель для детской комнаты", "Наборы детской мебели")));
            ...
            add(Map.of("Софа", new InnerClass("Мебель для гостиной", "Софы")));
            add(Map.of("Консоль", new InnerClass("Мебель для гостиной", "Консоли")));
            add(Map.of("гостиной.*Угловое окончание", new InnerClass("Мебель для гостиной", "Угловые окончания")));
